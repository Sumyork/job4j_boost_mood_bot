...
public class Main {
    ...
    CommandLineRunner loadDatabase(MoodRepository moodRepository,
        ...
        return args -> {
            ...
            addMoodContent(data);
            moodRepository.saveAll(data.stream()
    ...
    private static void addMoodContent(List<MoodContent> data) {
    ...
    private static void addAward(List<Award> awards) {
        ...
        awards.add(new Award("Награда 'Настроение месяца'", "За поддержание хорошего или отличного "
                + "настроения в течение целого месяца. Награда: Специальный значок, "
